...
namespace NetCams
{
    public class FindEdgeDefinition : NetCams.ToolDefinition
    {
        public FindEdgeDefinition(TestSequence testSequence)
            : base(testSequence)
		{
            ...
            mEdgeLocation.Type = DataType.DecimalNumber;
		...
		{
            new FindEdgeInstance(this, theExecution);
		}
        ...
        private bool mOldSlowModeTest = false;
        [CategoryAttribute("Infrastructure Test"),
        DescriptionAttribute("This is only to be used for testing by UVision developers.")]
        public bool OldSlowModeTest
        {
            get { return mOldSlowModeTest; }
            set
            {
                HandlePropertyChange(this, "OldSlowModeTest", mOldSlowModeTest, value);
                mOldSlowModeTest = value;
            }
        }
        ...
        public enum EdgeTypeSelectionFilters
        {
            NotDefined = 0,
            BrightToDark,
            DarkToBright
        ...
        private EdgeTypeSelectionFilters mEdgeTypeSelectionFilter = EdgeTypeSelectionFilters.NotDefined;
        [CategoryAttribute("Parameters"),
        DescriptionAttribute("")]
        public EdgeTypeSelectionFilters EdgeTypeSelectionFilter
        {
            get { return mEdgeTypeSelectionFilter; }
            set
            {
                HandlePropertyChange(this, "EdgeTypeSelectionFilter", mEdgeTypeSelectionFilter, value);
                mEdgeTypeSelectionFilter = value;
            }
        }

        private DataValueDefinition mDarkSurface_AvgIntensity_Max;
        [CategoryAttribute("Parameters"),
        DescriptionAttribute("")]
        public DataValueDefinition DarkSurface_AvgIntensity_Max
        {
            get { return mDarkSurface_AvgIntensity_Max; }
            set
            {
                HandlePropertyChange(this, "DarkSurface_AvgIntensity_Max", mDarkSurface_AvgIntensity_Max, value);
                mDarkSurface_AvgIntensity_Max = value;
            }
        }
